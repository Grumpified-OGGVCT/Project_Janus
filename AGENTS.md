...
See `.github/agents/hats.agent.md` for the full adapted 11-Hat Aegis-Nexus CoVE review system. Key hats for Project Janus:

| Hat | Focus |
|---|---|
| 🔴 Red (Chaos) | Fail-states, resilience, demo page functional integrity (UPKEEP) |
| ⚫ Black (Security) | OWASP Top 10 2025, zero trust, supply chain, adversarial testing |
| ⚪ White (Data) | Performance, data integrity, test coverage metrics |
| 🟡 Yellow (Value) | Synergies, optimization, missed opportunities |
| 🟢 Green (Evolution) | Feature completeness, i18n, feature parity (UPKEEP) |
| 🔵 Blue (Process) | Observability, operational readiness, GUI/demo sync (UPKEEP) |
| 🟣 Indigo (Integration) | API contracts, cross-component wiring verification (UPKEEP) |
| 🩵 Cyan (Innovation) | AI/ML validation, prompt injection defense |
| 🟪 Purple (Compliance) | OWASP LLM Top 10, EU AI Act, GDPR, ALIGN rules |
| 🟠 Orange (DevOps) | CI/CD security, containers, IaC validation |
| 🪨 Silver (Token) | Context optimization, cost efficiency |

### GUI & Demo Page Upkeep Agents
